...
class _ProductListScreenState extends State<ProductListScreen> {
  ...
  void initState() {
    ...
    context.read<ProductBloc>().add(FetchProduct(productCategory: 'All'));
  }
  ...
  Widget productListWidget() {
    return BlocConsumer<ProductBloc, ProductState>(
      ...
      builder: (context, state) {
        ...
        if (state is FetchProductLoader) {
          return const Center(
          ...
          listener: (context, state) {
            if (state is ProductFilterAppliedState) {
              ...
              // if(currentFilter == true){
                context.read<ProductBloc>().add(FetchProduct(productCategory: selectCategory, sort: 'desc'));
              // }
            }
  ...
  void onFilterClick() {
    ...
    context.read<ProductFilterBloc>().add(ProductFilterDesEvent(productFilterApplied: !currentFilter));
  }
